...
| Trading Economics calendar | Not adopted for MVP | It is outside the operator budget; commercial calendar functionality remains deferred. |
...
It does not scrape a calendar, ingest data into PostgreSQL, or adopt a paid
source. The verifier checks that the
