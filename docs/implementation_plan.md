...
The authoritative sequence is M0–M32 in `milestone_registry.json`. Work proceeds one milestone at a time; each milestone declares dependencies, bounded scope, artifacts, verification, real-world surface, evidence freshness, and invalidation triggers.
