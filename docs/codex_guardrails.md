...
The root `AGENTS.md` is the concise persistent instruction source. This companion rationale applies to all development:

- Preserve unrelated work and inspect before editing.
- Execute only the active milestone and stop after closeout.
- Use fixed commands and catalogs; never expose arbitrary remote execution.
