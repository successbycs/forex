...
CREATE TABLE IF NOT EXISTS forex.demo_trade_session (
    ...
    max_notional_usd NUMERIC(12,2) NOT NULL CHECK (max_notional_usd > 0 AND max_notional_usd <= 10000.00),
    max_cumulative_notional_usd NUMERIC(12,2) NOT NULL CHECK (max_cumulative_notional_usd > 0 AND max_cumulative_notional_usd <= 100000.00),
...
CREATE TABLE IF NOT EXISTS forex.demo_trade_proposal (
    ...
    notional_usd NUMERIC(12,2) CHECK (notional_usd > 0 AND notional_usd <= 10000.00),
