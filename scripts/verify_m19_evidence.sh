...
for marker in ('FOREX_M19_LINEAGE_VERIFY_OK','model=qwen2.5:3b=true','demo_only=true','validated=true','research_only=true','hashes_present=true','decision_linkage=true','no_order_fields=true'): assert marker in output
