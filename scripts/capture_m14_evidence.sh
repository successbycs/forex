...
assert p['ok'] and 'FOREX_M14_REGIME_PROBE_OK' in out and 'bars=6' in out and 'eligible_bars=6' in out and 'regime=' in out and 'event_window=EVENT_BLACKOUT' in out and 'decision_at=2026-09-01 20:00:00+12' in out and 'flat_by=2026-09-02 08:00:00+12' in out and 'snapshot=m2-m1-eurusd-h1-720' in out and 'source=mt5-demo-eurusd-h1' in out and 'daylight_saving=UTC_FIXED' in out
