...
p=json.loads((b/'regime-probe.json').read_text()); out=p['result']['stdout']; assert p['ok'] and 'FOREX_M14_REGIME_PROBE_OK' in out and 'bars=6' in out and 'regime=' in out and 'event_window=EVENT_BLACKOUT' in out and 'decision_at=2026-08-28 08:00:00+00' in out and 'flat_by=2026-08-28 20:00:00+00' in out and 'daylight_saving=UTC_FIXED' in out
