...
p=json.loads((b/'regime-probe.json').read_text()); out=p['result']['stdout']; assert p['ok'] and 'FOREX_M14_REGIME_PROBE_OK' in out and 'bars=6' in out and 'regime=' in out and 'event_window=' in out and 'session=08:00Z-20:00Z' in out and 'daylight_saving=UTC_FIXED' in out
