...
def test_ledger_filters_to_current_nz_day_and_keeps_rejection_pnl_na():
    ...
    }, {"submitted_at_utc": "2026-09-03T01:27:33+12:00", "action": "SELL", "lifecycle": "TERMINAL_REJECTED"}], nz_day=date(2026, 9, 4))
    assert "04/09 01:27:33" in screen
    assert "03/09 01:27:33" not in screen
    assert "N/A — no order opened" in screen
